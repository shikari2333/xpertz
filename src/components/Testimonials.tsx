      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="h-full bg-gradient-to-br from-slate-800/50 to-slate-900/50 p-8 rounded-2xl border border-slate-700 group-hover:border-cyan-500/50 transition-all duration-300 backdrop-blur-sm">
                <div className="flex items-center justify-between mb-6">
                  <Quote className="text-cyan-400 opacity-50" size={40} />
        ...
        >
          <div className="inline-flex items-center space-x-6 bg-gradient-to-r from-slate-800/50 to-slate-900/50 p-6 rounded-2xl border border-slate-700">
